...
# FILENAME: 'cnn.py'
# SPECIFICATION: Extracted the train and test images from the'digit_dataset' folder. Each image was resized and converted to grayscale to prepare
# the data for input into the CNN model. A CNN architecture was constructed, where both train and test images were fed to. The model was then evaluated,
...
# --> add your Python code here
folder_path_train = r"C:\Users\micri\OneDrive - Cal Poly Pomona\Desktop\CS4210_HW4\digit_dataset\train"
folder_path_test = r"C:\Users\micri\OneDrive - Cal Poly Pomona\Desktop\CS4210_HW4\digit_dataset\test"
X_train, Y_train = load_digit_images_from_folder(folder_path_train)
X_test, Y_test = load_digit_images_from_folder(folder_path_test)
...
# --> add your Python code here
print(f"The accuracy of the CNN model: {round(acc,6)}")
print(f"The loss of the CNN model: {round(loss,6)}")